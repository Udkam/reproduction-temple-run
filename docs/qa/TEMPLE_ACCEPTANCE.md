...
- R1 canyon geometry uses closed near/mid/far components with genuine gaps, outward/non-degenerate topology, multi-level terraces, broken ends, non-mirrored notch profiles, and bounded overhangs. R1E keeps those counts and silhouettes fixed while applying the tracked clean-room basalt map to all three bands through finite deterministic world-scaled UVs. Upward caps/shelves, vertical walls/returns, and undersides must remain visually distinct; near detail/value variation is greater than mid and far without black crushing, flat slabs, stretched seams, shimmer, or loss of route readability.
